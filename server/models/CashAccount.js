...
CashAccountSchema.virtual('title').get(function() {
  // This will be populated by the controller when needed
  return '';
});
// Ensure only one default cash account per company
...
CashAccountSchema.set('toJSON', { virtuals: true });
CashAccountSchema.set('toObject', { virtuals: true });
